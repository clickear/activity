...
public interface TaskFlowControlService
{
     ...
     * 后加签
     */
    ActivityImpl[] insertTasksAfter(String targetTaskDefinitionKey,String taskId,String doUserId,String[] names ,String... assignees) throws Exception;
     ...
     */
    ActivityImpl split(String targetTaskDefinitionKey, boolean isSequential, String doUser,String... assignees) throws Exception;

    /**
     * 分裂某节点为多实例节点
     */
    ActivityImpl split(String targetTaskDefinitionKey, String doUser,  String... assignee) throws Exception;

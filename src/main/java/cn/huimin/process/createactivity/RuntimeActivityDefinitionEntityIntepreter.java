...
{
    RuntimeActivityCreateInterface _entity;

    public RuntimeActivityDefinitionEntityIntepreter(RuntimeActivityCreateInterface entity)
    {
        super();
        _entity = entity;
    }
    ...
    public List<String> getActivityNames(){
        return _entity.getProperty("activityNames");
    }
    public void setActivityNames(List<String> activityNames){
        _entity.setProperty("activityNames",activityNames);
    }

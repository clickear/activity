...
CREATE TABLE `act_process_type` (
  ...
  `state_` tinyint(4) NOT NULL DEFAULT '0' COMMENT '有效性',
...
DROP TABLE IF EXISTS hm_system_id;

CREATE TABLE `hm_system_id` (
  `id_` int(11) NOT NULL AUTO_INCREMENT,
  `name_` varchar(64) NOT NULL COMMENT '系统名称',
  `code_id` varchar(20) NOT NULL COMMENT '系统标识符',
  PRIMARY KEY (`id_`),
  KEY `code_id` (`code_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='系统标志';
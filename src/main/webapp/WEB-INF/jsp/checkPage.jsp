...
<div class="container">
            ...
            <div class="col-lg-12" style="position:relative;">
                <div class="panel panel-info" style="width: 99%; height:98%;">
                    ...
                    <div class="panel-body">
                        ...
                        <table table class="table-bordered  text-center "
                               style="width: 99%;margin:-20px auto; WORD-WRAP: break-word;BORDER-TOP: medium none;BORDER-BOTTOM: medium none;BORDER-LEFT: medium none; border:1px;">
 ...
 <%--                   <button class="btn btn-xs btn-success" onclick="addActivity()" style="margin-top: 0px" id="addActivity">
                    ...
                    <button class="btn btn-xs btn-success" onclick="cutActivity()" style="margin-top: 0px" id="cutActivity" >
                        减签
                    </button>--%>
                    <button class="btn btn-xs btn-success" onclick="addActivity()" style="margin-top: 0px" id="addActivity">
                        加签
                    ...
                    <button class="btn btn-xs btn-success" onclick="back()" style="margin-top: 0px">
                        回退
                    </button>
                    <button class="btn btn-xs btn-success" onclick="deleteProcess()" style="margin-top: 0px">
                        终止
                    </button>
                    <button class="btn btn-xs btn-success" onclick="informProcess()" style="margin-top: 0px">
                        知会
                    </button>
                </c:if>
...
<script>
    ...
    //通过审批
    function doCheck() {
        url = "${ctx}/process/doTask";
        reson = $("#remark").val();
        noProblem = $("input[name='noProblem']:checked").val();
        if (noProblem == 'false') {
            //这里不同意的填写回退的地址
            //url = "${ctx}/handle/doBackFowardByProcessId";
            if (reson == null || reson == "") {
                alert("不同意，请填写意见");
                return;
            }
        ...
        $.ajax({
            url: url,
            //data:{'processId':processId,'taskid':taskId,'remark': reson,'noProblem':noProblem},
            data: $("#checkForm").serialize(),
            type: "POST",
            dataType: 'json',
            async: false,

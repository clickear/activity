 ...
 * roleset岗位设置
 */
var roleSetCtrl = [ '$scope', '$modal', function($scope, $modal) {

    // Config for the modal window
    var opts = {
        template:  'editor-app/configuration/properties/roleSet-popup.html?version=' + Date.now(),
        scope: $scope
    };
...
var roleSetPopupCtrl = [ '$scope','$http','$q', '$translate', function($scope,$http,$q, $translate) {
    //wyp3 流程挂接的形式
    $scope.processName = "";
    $scope.admins = [];

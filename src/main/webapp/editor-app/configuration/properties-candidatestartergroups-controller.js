 ...
 */
var candidateStarterGroupsCtrl = [ '$scope', '$modal', function($scope, $modal) {

    // Config for the modal window
    var opts = {
        template:  'editor-app/configuration/properties/candidatestartergroups-popup.html?version=' + Date.now(),
        scope: $scope
    };
...
var candidateStarterGroupsPopupCtrl = [ '$scope','$http','$q', '$translate', function($scope,$http,$q, $translate) {
    //wyp3 流程挂接的形式
    $scope.processName = "";
    $scope.admins = [];

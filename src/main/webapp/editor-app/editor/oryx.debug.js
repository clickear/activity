...
/** @lends ORYX.Core.AbstractShape.prototype */
{
	...
	construct: function(options, stencil, facade) {
		...
		this._stencil.properties().each((function(property) {
			...
			console.info("wyp overrideid");
			if(this.properties["oryx-overrideid"]==""){
				this.properties["oryx-overrideid"] = ORYX.Editor.provideId();
				this.propertiesChanged["oryx-overrideid"] = true;
			}
